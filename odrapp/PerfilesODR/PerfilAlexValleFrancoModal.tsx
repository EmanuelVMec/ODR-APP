...
const PerfilAlexValleFrancoModal: React.FC<ModalProps> = ({ visible, onClose }) => {
  return (
    <Modal
      visible={visible}
      animationType="slide"
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.headerCard}>
              <Image
                ...
                resizeMode="cover"
              />
              <Text style={styles.name}>PhD. Alex Valle Franco (Ecuador)</Text>
              <Text style={styles.role}>DOCENTE</Text>
            </View>

            <View style={styles.sectionCard}>
              <Text style={[styles.sectionTitle, { alignSelf: 'center' }]}>Perfil</Text>
              <Text style={styles.bulletText}>• Doctor en Ciencias Jurídicas por la Universidad de Bremen (Alemania), con dos postdoctorados en Derechos de la Naturaleza por las universidades de Bremen y Kassel.</Text>
              <Text style={styles.bulletText}>• Posee formación en Ciencias Sociales (FLACSO, Ecuador), Derechos Humanos y Democracia (UASB-Ecuador), y en Derecho Penal y Justicia Indígena (Uniandes).</Text>
              ...
              <Text style={styles.bulletText}>• Es director de la Red Jurídica Crítica del Ecuador (REDIJC) y secretario general del Comité Permanente para la Prevención del Delito en América Latina (COPLAD-ILANUD).</Text>
              ...
              <Text style={styles.bulletText}>• Tiene publicaciones académicas en temas como derechos humanos, derechos de la naturaleza, migración y filosofía del derecho, alineadas con sus líneas de investigación centrales.</Text>
            </View>
          </ScrollView>
        </View>
      </View>
...
export default PerfilAlexValleFrancoModal;
