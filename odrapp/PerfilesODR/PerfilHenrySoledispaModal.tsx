...
interface PerfilHenrySoledispaModalProps {
  visible: boolean;
  onClose: () => void;
}

const PerfilHenrySoledispaModal: React.FC<PerfilHenrySoledispaModalProps> = ({ visible, onClose }) => {
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.headerCard}>
              <Image
                ...
                resizeMode="cover"
              />
              <Text style={styles.name}>Henry Stalyn Soledispa Vera</Text>
              <Text style={styles.role}>Director de Tics y Diseños</Text>
            </View>

            <View style={styles.sectionCard}>
              <Text style={[styles.sectionTitle, { alignSelf: 'center' }]}>Perfil</Text>
              <Text style={styles.textCenter}>
                Ingeniero en Sistemas de Información con experiencia en diseño y desarrollo de sistemas empresariales. Apasionado por la tecnología y la innovación, con habilidades en programación avanzada y gestión de proyectos tecnológicos.
              </Text>
            </View>
            ...
            <View style={styles.rowCards}>
              <View style={styles.sectionCardSmall}>
                ...
                {renderBar('Programación avanzada', 95)}
                {renderBar('Gestión de proyectos', 90)}
            ...
            <View style={styles.sectionCard}>
              ...
              <Text style={styles.bulletText}>• Ingeniero en Sistemas de Información - Universidad Técnica de Cotopaxi</Text>
              <Text style={styles.bulletText}>• Técnico en Instalaciones Eléctricas - Unidad Educativa 7 de Octubre</Text>
            </View>

            <View style={styles.sectionCard}>
              <MaterialIcons name="workspace-premium" size={22} color="#6046FF" style={{ marginBottom: 2 }} />
              <Text style={styles.sectionTitle}>Experiencia Profesional</Text>
              <Text style={styles.bulletText}>• Atención al cliente - ModasMary's (Mar 2024 - Abr 2024)</Text>
              <Text style={styles.bulletText}>• Desarrollador Web y App Movil - InartPoint (Abr 2024 - Abr 2025)</Text>
            </View>
            ...
            <View style={styles.sectionCard}>
              ...
              <Text style={styles.bulletText}>• Autor de un artículo científico internacional sobre predicción automatizada del crecimiento y productividad de plantas leguminosas mediante inteligencia artificial, publicado en Revista Ingenio Global (2025). DOI: <Text style={{ color: 'blue' }} onPress={() => Linking.openURL('https://doi.org/10.62943/rig.v4n2.2025.320')}>10.62943/rig.v4n2.2025.320</Text></Text>
            </View>

            <View style={styles.sectionCard}>
              <MaterialIcons name="contact-phone" size={22} color="#6046FF" style={{ marginBottom: 2 }} />
              <Text style={styles.sectionTitle}>Contacto</Text>
              <Text style={styles.text}><FontAwesome name="phone" size={16} color="#1a2c6c" />  +593 97 900 6812</Text>
              <Text style={styles.text}><MaterialIcons name="email" size={16} color="#1a2c6c" />  stalyn01062003@gmail.com</Text>
...
export default PerfilHenrySoledispaModal;
